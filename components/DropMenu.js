...
export default function DropMenu() {
  ...
  return (
    <Menu as="div" className="relative z-10 inline-block text-left ">
      <div>
        <Menu.Button className=" hover:bg-lightBlue-400 dark:ring-lightBlue-700 dark:hover:bg-lightBlue-600 ml-2 cursor-pointer rounded-full bg-zinc-300 ring-zinc-400 transition-all hover:ring-1 dark:bg-zinc-700">
          <motion.button
